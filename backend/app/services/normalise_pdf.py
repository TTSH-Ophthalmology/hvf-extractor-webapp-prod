"""
services/normalise_pdf.py — Header alignment algorithm for HVF PDFs.

Ported verbatim from the original working app (core/normalise_pdf.py).
Uses dynamic programming to map positional PDF text values onto template
labels without index-shifting when optional fields are missing.
"""
